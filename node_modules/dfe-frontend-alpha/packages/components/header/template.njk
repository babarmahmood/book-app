...
<img src="/{{params.logoPath}}/dfe-logo.png" class="dfe-logo" alt="DfE Homepage">
<img src="/{{params.logoPath}}/dfe-logo-alt.png" class="dfe-logo-hover" alt="DfE Homepage">
{% endset %}
...
{%- if params.classes %} {{ params.classes }}{% endif %}" role="banner" {%- for attribute, value in params.attributes %} {{ attribute }}="{{ value }}"{% endfor %}>
  ...
  <div class="dfe-width-container dfe-header__container">
    ...
    <div class="dfe-header__logo">
      <a class="dfe-header__link{% if params.service %} dfe-header__link--service {% endif %}" href="{% if params.homeHref %}{{ params.homeHref }}{% else %}/{% endif %}" aria-label="{% if params.ariaLabel %}{{ params.ariaLabel }}{% else %}DfE homepage{% endif %}">
        {{ dfeLogo | safe }}
        {%- if params.service %}
